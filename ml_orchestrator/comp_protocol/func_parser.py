...
class FunctionParser:
    @classmethod
    def get_class_def(cls, component: Any) -> ComponentProtocol:
        is_class_def = isinstance(component, type)
        return component if is_class_def else component.__class__
    ...
    def get_function_parts(self, comp_class):
    ...
    @classmethod
    def comp_execute(cls, comp: ComponentProtocol) -> str:
    ...
    @classmethod
    def comp_vars(cls, component: ComponentProtocol) -> Dict[dataclasses.Field, Any]:
        component_class = cls.get_class_def(component)
        fields = dataclasses.fields(component_class)
        ins_vars = dict()
        for field in fields:
